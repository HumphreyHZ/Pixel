...
export const mainRoutes: DemoState["route"][] = ["home", "companion", "focus", "bank", "explore"];
...
export const seedState: DemoState = {
  ...
  presets: [
    { id: "design", title: "深度专注", minutes: 25, tone: "sky" },
    { id: "work", title: "任务推进", minutes: 30, tone: "peach" },
    { id: "reading", title: "阅读整理", minutes: 15, tone: "sage" },
    { id: "move", title: "快速热身", minutes: 10, tone: "amber" },
  ],
  tasks: [
    { id: "task-1", title: "完成 1 轮 25 分钟专注", status: "todo", linkedFocusPresetId: "design" },
    { id: "task-2", title: "去奖励页领取今日步数能量", status: "todo", linkedFocusPresetId: "move" },
    { id: "task-3", title: "兑换晶石后去晨露草坪探索", status: "todo", linkedFocusPresetId: "work" },
  ],
  notes: [
    { id: "note-1", title: "陪伴回复先给下一步", body: "每条宠物回复都应该把用户往下一步带，比如专注后提醒领奖，领奖后提醒去探索。" },
  ...
  aiCards: [
    {
      ...
      type: "journeyPlan",
      title: "今天建议这样走",
      description: "说一句你现在最想推进的事，我会先帮你排成一条顺手的旅程。",
      ctaLabel: "生成今日主线",
      ctaRoute: "home",
    ...
    },
    {
      ...
      type: "contextHint",
      title: "这一步更适合怎么走",
      description: "这页的重点不是赢，而是感受资源消耗、状态变化和即时反馈。",
      ctaLabel: "开始一场试炼",
      ctaRoute: "battle",
  ...
  achievements: [
    ...
    { id: "a-2", title: "能量兑换", description: "完成第一次领奖兑换", unlocked: true },
